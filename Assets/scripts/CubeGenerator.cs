...
public class CubeGenerator : MonoBehaviour
{
    ...
    public GameObject cubePrefab;           //생성할 큐브 프리;팹
    ...
    public void GenCube()
    {
        Vector3 myPosition = transform.position;        //스크립트가 붙은 오브젝트 위치 (x,y,z)
        GameObject forstCube = Instantiate(cubePrefab, myPosition, Quaternion.identity);    //첫번째 큐브 생성
